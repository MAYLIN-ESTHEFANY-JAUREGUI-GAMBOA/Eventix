...
public class ReportesView extends JFrame {
    ...
    public ReportesView() {
        ...
        setTitle("📊 Gestión de Reportes - Eventix");
        setSize(900, 600);
    ...
    private void initComponents() {
        ...
        JLabel lblSubtitulo =
                new JLabel("Genera y exporta reportes de eventos");
        ...
        btnVerReporte = createCardButton(card1);
        ...
        btnExportarPDF = createCardButton(card2);
        ...
        btnCerrar = createCardButton(card3);
